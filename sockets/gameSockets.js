...
async function startRound() {
  ...
  ioInstance.emit("timerUpdate", gameState.timer);
  ioInstance.to(drawer.socketId).emit("secretWord", gameState.currentWord);
  ioInstance.emit("clearCanvas");
...
async function emitScoreboard() {
  ...
  ioInstance.emit("updateScoreboard", playersForScoreboard);
}
